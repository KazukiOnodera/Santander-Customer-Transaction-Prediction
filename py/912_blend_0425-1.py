...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 25 15:57:47 2019
...
# 
# =============================================================================
SUBMIT_FILE_PATH = '../output/0425-1.csv.gz'

COMMENT = 'lgb(onodera harada akiyama)'
...
sub_real = (sub_lgb.rank()*1)

# fake
sub_fake = fake_lgb.rank()
